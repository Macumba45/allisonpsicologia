...
const Video: FC = () => {
  ...
  return (
    <MainContainer>
      ...
      <VideoContainer>
        <VideoUrl width="560" height="315" src="https://www.youtube.com/embed/yjfw5PP7f6s" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></VideoUrl>
      </VideoContainer>
    </MainContainer>
  );
};
