...
const Video: FC = () => {
  ...
  return (
    <MainContainer>
      ...
      <VideoContainer>
        <VideoUrl src="https://www.youtube.com/embed/aoe9M02poto?controls=1" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></VideoUrl>
      </VideoContainer>
    </MainContainer>
  );
};
